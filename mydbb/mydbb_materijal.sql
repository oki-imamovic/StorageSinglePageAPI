...
CREATE TABLE `materijal` (
  ...
  `naziv_materijala` varchar(45) NOT NULL,
  `kolicina_materijala` float NOT NULL,
  `mjerna_jedinica` varchar(45) NOT NULL,
  `sifra_materijala` int NOT NULL,
...
INSERT INTO `materijal` VALUES (11,'Oki',45.78,'kg',11111111);
